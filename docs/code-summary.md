...
- `docs/machine-learned-bot.md`
  - Design document for the proposed offline-trained `machine-learned` bot `Michelle`, including runtime architecture, artifact format, and phased training plan.
