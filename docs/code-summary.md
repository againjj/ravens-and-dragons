...
- `docs/machine-learned-bot-improvements.md`
  - Planning notes for making the evolved `machine-learned` bot `Michelle` stronger, including shallow search, richer fitness, outcome learning, side-specific weights, and evaluation reliability.
