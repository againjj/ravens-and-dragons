...
- `src/main/kotlin/com/ravensanddragons/game/*.kt`
  ...
  - Machine-learned phase 4 adds `MachineLearnedStrengtheningLoop.kt` for candidate-vs-incumbent leagues, baseline comparisons, candidate self-play batches, hard-position replay mining, opening diversity controls, and promotion-threshold decisions.
