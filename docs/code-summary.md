...
- `src/main/resources/bots/machine-trained/*.json`
  - Bundled per-ruleset machine-trained artifacts. The Sherwood artifact for `Michelle` is now schema 5 and matches the side-specialized feature encoder.
