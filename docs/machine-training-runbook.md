...
1. The server loads JSON artifacts from `ravens-and-dragons/backend/src/main/resources/bots/machine-trained/*.json`.
...
```bash
cp ravens-and-dragons/backend/src/main/resources/bots/machine-trained/sherwood-rules.json build/machine-trained-candidate/sherwood-rules.previous.json
```
