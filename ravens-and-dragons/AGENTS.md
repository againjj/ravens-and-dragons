...
- `ravens-and-dragons/frontend/src/main/frontend/features/game` should own Redux slices, selectors, thunks, and stream lifecycle helpers for game/session behavior.
- `ravens-and-dragons/frontend/src/main/frontend/features/ui` should own browser-local UI state such as selection.
- `ravens-and-dragons/frontend/src/main/frontend/game-client.ts` should stay focused on REST/SSE transport helpers and client-side request handling.
- `ravens-and-dragons/frontend/src/main/frontend/hooks` should wrap browser APIs such as fullscreen and resize observation.
...
- Use `./gradlew :ravens-and-dragons:backend:test` for focused backend tests.
- Use `./gradlew :ravens-and-dragons:frontend:test` for focused frontend tests.
