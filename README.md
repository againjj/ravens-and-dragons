...
- Use a shared `Ayazian Games` app shell with compact fixed header/footer chrome, a lobby-linked title after login, a turn-aware username menu, and scrollable page content
