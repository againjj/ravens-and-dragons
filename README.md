...
- Play the included Lunar Base game with 2-6 players, optional influence cards, private hands, completed-orb counts from player boards, a shared supply/stock/discard area, an action panel for turn/action resolution, editable zoomable table, and smooth animated hand, discard, supply, stock, station, and module-placement card movement
...
The frontend build uses Vite 8.0.16 so the Gradle-managed npm install/test flow reports no audited vulnerabilities.
